...
public class CreateVoiceCallTest {
    ...
    public void Test03_makeCallAndRemoteHangUp() throws InterruptedException {
        ...
        service.initialRegister("dfive-ims.dek.vn","nga", "nga");

        service.makeCall("sip:chi@dfive-ims.dek.vn", null, false);
        Call call= service.getCore().getCurrentCall();
        Thread.sleep(5000);

        assertEquals(Call.State.OutgoingRinging, call.getState());
    ...
    public void Test01_makeCallWhenRemoteOffline() throws InterruptedException {
        ...
        service.makeCall("sip:du@dfive-ims.dek.vn", null, false);
...
//            service.rejectCall();
    ...
    public void Test04_makeCallAndSameTime() throws InterruptedException {
        ...
        Thread.sleep(5000);
        service.makeCall("sip:diep@dfive-ims.dek.vn", null, false);
        Call second_call= service.getCore().getCurrentCall();
        Thread.sleep(5000);

        assertEquals(Call.State.OutgoingRinging, second_call.getState());
